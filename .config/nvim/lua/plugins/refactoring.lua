return {
    ...
    --stylua: ignore
	keys = {
		{ "<leader>re", function() require("refactoring").select_refactor() end, mode = { "n", "v" }, desc = "Select Refactor" },
		...
		{ "<leader>rP", function() require("refactoring").debug.printf({ above = false }) end, mode = "n", desc = "Debug Printf" },
